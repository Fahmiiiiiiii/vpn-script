...
cd /etc/openvpn/;
wget -q -O cert.zip "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Data/ovpn_cert.zip";
unzip -o cert.zip;
rm -f cert.zip;
mkdir -p config;
rm -r -f server;
...
wget -q -O /etc/openvpn/tcp.conf "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/OpenVPN/tcp_conf";
wget -q -O /etc/openvpn/udp.conf "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/OpenVPN/udp_conf";

# // Remove The OpenVPN Service & Replace New OpenVPN Service
rm -f /lib/systemd/system/openvpn-server@.service;
wget -q -O /etc/systemd/system/openvpn@.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/openvpn_service";
...
wget -q -O /etc/openvpn/config/tcp.ovpn "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/OpenVPN/tcp_client";
wget -q -O /etc/openvpn/config/udp.ovpn "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/OpenVPN/udp_client";
wget -q -O /etc/openvpn/config/ssl.ovpn "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/OpenVPN/ssl_client";
