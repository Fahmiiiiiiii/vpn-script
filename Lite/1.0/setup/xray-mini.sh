...
wget -q -O /usr/local/wildydev21/xray-mini "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Core/xray-mini";
chmod +x /usr/local/wildydev21/xray-mini;

# // Downloading XRay Mini Service
wget -q -O /etc/systemd/system/xray-mini@.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/xray-mini_service";
...
wget -qO- "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Xray-Mini/1.0.Stable/tls_json" | jq '.inbounds[0].streamSettings.xtlsSettings.certificates += [{"certificateFile": "'/root/.acme.sh/${domain}_ecc/fullchain.cer'","keyFile": "'/root/.acme.sh/${domain}_ecc/${domain}.key'"}]' > /etc/xray-mini/tls.json;
wget -q -O /etc/xray-mini/nontls.json "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Xray-Mini/1.0.Stable/nontls_json";
wget -q -O /etc/xray-mini/shadowsocks.json "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Xray-Mini/1.0.Stable/shadowsocks_json";
wget -q -O /etc/xray-mini/socks.json "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Xray-Mini/1.0.Stable/socks_json";
wget -q -O /etc/xray-mini/http.json "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Xray-Mini/1.0.Stable/http_json";
