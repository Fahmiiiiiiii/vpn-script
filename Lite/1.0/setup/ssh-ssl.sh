...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/password";
chmod +x /etc/pam.d/common-password;

# // Installing Dropbear
wget -q -O /etc/ssh/sshd_config "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/sshd_config";
/etc/init.d/ssh restart;
apt install dropbear -y;
wget -q -O /etc/default/dropbear "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/dropbear_conf";
chmod +x /etc/default/dropbear;
echo "/bin/false" >> /etc/shells;
echo "/usr/sbin/nologin" >> /etc/shells;
wget -q -O /etc/wildydev21/banner.txt "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/banner.txt";
...
cd /root/;
wget -q -O stunnel5.zip "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Core/stunnel5.zip";
...
wget -q -O /etc/stunnel5/stunnel5.conf "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/stunnel5_conf";
wget -q -O /etc/stunnel5/stunnel5.pem "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Data/stunnel_cert";
wget -q -O /etc/systemd/system/stunnel5.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/stunnel5_service";
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/stunnel5_init";
...
# // Installing Ws-ePro
wget -q -O /usr/local/wildydev21/ws-epro "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Core/ws-epro";
chmod +x /usr/local/wildydev21/ws-epro;
wget -q -O /etc/systemd/system/ws-epro.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/ws-epro_service";
chmod +x /etc/systemd/system/ws-epro.service;
wget -q -O /etc/wildydev21/ws-epro.conf "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/ws-epro_conf";
...
# // Instaling SSLH
apt install sslh -y;
wget -q -O /lib/systemd/system/sslh.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/sslh_service"
