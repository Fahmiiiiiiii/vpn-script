...
wget -q -O /etc/wildydev21/ssr-server/SSR-Server.zip "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Core/SSR-Server.zip";
...
wget -q -O /etc/init.d/ssr-server "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/ssr-server_init";
