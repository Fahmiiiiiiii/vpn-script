...
# // Installing neofetch
wget -q -O /usr/local/sbin/neofetch "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Core/neofetch"; chmod +x /usr/local/sbin/neofetch;
...
wget -q -O vnstat.zip "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Core/vnstat.zip";
...
# // Installing UDP Mini
wget -q -O /usr/local/wildydev21/udp-mini "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Core/udp-mini";
chmod +x /usr/local/wildydev21/udp-mini;
wget -q -O /etc/systemd/system/udp-mini-1.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/udp-mini-1.service";
wget -q -O /etc/systemd/system/udp-mini-2.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/udp-mini-2.service";
wget -q -O /etc/systemd/system/udp-mini-3.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/udp-mini-3.service";
...
apt install squid -y;
wget -q -O /etc/squid/squid.conf "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/squid_conf";
sed -i $MYIP2 /etc/squid/squid.conf;
mkdir -p /etc/wildydev21/squid;
/etc/init.d/squid restart;

# // Installing OHP Proxy
wget -q -O /usr/local/wildydev21/ohp-mini "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Core/ohp-mini";
chmod +x /usr/local/wildydev21/ohp-mini
wget -q -O /etc/systemd/system/ohp-mini-1.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/ohp-mini-1_service"
wget -q -O /etc/systemd/system/ohp-mini-2.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/ohp-mini-2_service"
wget -q -O /etc/systemd/system/ohp-mini-3.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/ohp-mini-3_service"
wget -q -O /etc/systemd/system/ohp-mini-4.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/ohp-mini-4_service"
...
wget -q -O /etc/systemd/system/ssh-kill.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/ssh-kill_service";
wget -q -O /etc/systemd/system/vmess-kill.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/vmess-kill_service";
wget -q -O /etc/systemd/system/vless-kill.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/vless-kill_service";
wget -q -O /etc/systemd/system/trojan-kill.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/trojan-kill_service";
wget -q -O /etc/systemd/system/ss-kill.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/ss-kill_service";
wget -q -O /usr/local/wildydev21/vmess-auto-kill "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/menu/pro/autokill/vmess-kill.sh"; chmod +x /usr/local/wildydev21/vmess-auto-kill;
wget -q -O /usr/local/wildydev21/ssh-auto-kill "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/menu/pro/autokill/ssh-kill.sh"; chmod +x /usr/local/wildydev21/ssh-auto-kill;
wget -q -O /usr/local/wildydev21/vless-auto-kill "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/menu/pro/autokill/vless-kill.sh"; chmod +x /usr/local/wildydev21/vless-auto-kill;
wget -q -O /usr/local/wildydev21/trojan-auto-kill "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/menu/pro/autokill/trojan-kill.sh"; chmod +x /usr/local/wildydev21/trojan-auto-kill;
wget -q -O /usr/local/wildydev21/ss-auto-kill "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/menu/pro/autokill/ss-kill.sh"; chmod +x /usr/local/wildydev21/ss-auto-kill;
wget -q -O /etc/wildydev21/autokill.conf "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/menu/pro/autokill/autokill_conf";
...
# // Installing RC-Local
wget -q -O /etc/systemd/system/rc-local.service "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Service/rc-local_service";
wget -q -O /etc/rc.local "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/rc-local_conf";
