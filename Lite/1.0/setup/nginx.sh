...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/nginx_conf";
wget -q -O /etc/nginx/conf.d/wildydev21.conf "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/wildydev21_conf";
mkdir -p /etc/wildydev21/webserver/;
wget -q -O /etc/wildydev21/webserver/index.html "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/index.file";
