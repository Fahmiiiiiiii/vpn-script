...
echo "(C) Copyright by FahmiStore" > Copyright;
...
# // Upload to rclone
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Config/rclone_conf";
